<template>
  <div>
        ...
        <el-row :gutter="50">
          <el-col :span="12">
            <el-form-item label="用户名" prop="username">
              <el-input v-model="data.username" :maxlength="30" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="密码" prop="password">
              <el-input v-model="data.password" :maxlength="30" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
    ...
    <div class="drawer-btns">
      ...
      <el-button size="medium" type="primary" plain @click="reset('form')">重置</el-button>
    </div>
  </div>
</template>
<script>
